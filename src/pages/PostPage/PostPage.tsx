...
import type { Comment as CommentType } from '../../store/commentsSlice.ts';
import type { Post } from '../../store/postsSlice.ts';
...
} from '../../store/commentsSlice.ts';
import { useAppDispatch, useAppSelector } from '../../store/hooks.ts';
import { fetchPost, selectPostsLoading, selectSelectedPost } from '../../store/postsSlice.ts';
